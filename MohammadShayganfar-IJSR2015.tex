...
section demonstrate that agreeing on a shared goal demands that the Robot to be
aware of its collaborator's emotions (here, frustration). 
...
potential solution (A4). This fact illustrates an advantage of
...
of replacing the tool, and asks whether the Astronaut agrees on that (B6).
