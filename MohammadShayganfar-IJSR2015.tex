...
STEAM \cite{tambe:flexible-teamwork}. We provide some examples of homogeneous
and heterogeneous agent/robot and human collaborations.
...
robotic laboratories \cite{green:collaboration-literature-review}. Some of the
works that we have reviewed consider applicability of emotions in their
architecture, and some of them pay more attention to the collaborative aspect of
their robot. However, all of these works lack a systematic integration of
emotion and collaboration theories with which they can explain both of the
collaboration structure and the underlying processes of collaboration
independent of a particular robot or a particular application. For the rest of
this section, we provide our review of several applications based on different
prominent collaboration theories which puts emphasis on the importance of the
collaborative robots and their applicaitons.
