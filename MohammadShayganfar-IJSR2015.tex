...
asscoiated with each mechanism using JESS (JAVA Expert System Shell), in order
...
postpone asking questions about the alternative solution bacause of the
...
that ignoring the Astroanut's negative emotion would cause an interpretation of
