...
\noindent\textbf{(Motivation: \textit{Motive \& Intention Formation})} Robot
forms new motives according to the result of a) appraisal with respect to the
shared goal, and b) reverse appraisal of the human's wrong emotion (i.e.,
neutral). Robot forms new beliefs about a) human's inferred mental states
(belief, intention, motive, goal, emotion), and b) the task status. Robot forms
new intention(s) with respect to the new beliefs.\\

\noindent\textbf{(Coping)} Based on the current mental states,
