...
\noindent\fbox{\begin{varwidth}{0.96\textwidth}\textit{\textbf{C2. Robot:}}
Okay. Don't worry. I can handle that.\end{varwidth}}\\
  
\noindent\fbox{\begin{varwidth}{0.96\textwidth} \textit{\textbf{C3. Astronaut:}}
...
\noindent\fbox{\begin{varwidth}{0.96\textwidth} \textit{\textbf{C4. Robot:}} I
might need to ask some questions while I am installing the second
panel.\end{varwidth}}\\

\noindent\fbox{\begin{varwidth}{0.96\textwidth} \textit{\textbf{C5. Astronaut:}}
