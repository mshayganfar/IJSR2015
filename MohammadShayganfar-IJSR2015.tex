...
reason for collaborators' commitment, and the necessity of communicating mental
states in order to maintain progress over the course of a collaboration. The
most prominent collaboration theories are based on plans and intentions
...
successful completion of the collaboration. In contrast, in Joint Intentions
theory, the notion of joint intention is viewed as a persistent commitment of
the team members to a shared goal. In this theory, once an agent enters into a
joint commitment with other agents, it should communicate its private beliefs to
other team members.
...
modifying the content of social interaction. Emotions possess these two
properties, and social functions of emotions explain some aspects of the
...
The very first utterance of the Astronaut (D1) is the same as
...
The Coping mechanism is responsible for adopting the appropriate behavior with
