...
We believe since collaboration is a special type of social context, social
...
example in Section \ref{sec:exp1}. The underlined utterance in the Robot's turn
C2, shows the Robot's awareness of the Astronaut's emotion. Also, the Robot does
not ask the Astronaut (because of perceiving her worriedness) if it is okay to
...
overall task (C3). Now, the Robot perceives the Astronaut's worriedness and
without asking the actual detailed questions about the delegated task, declares
...
installing the second panel (C4). Thus, the Robot not only prevents overwhelming
...
\subsection{Delegation of a Task (Emotional-Awareness)}
\label{sec:wt-exp3}
