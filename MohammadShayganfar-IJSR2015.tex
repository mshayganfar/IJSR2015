...
\begin{description}
  ...
  \item \textit{\textbf{A2. Robot:}} Okay. Don't worry. I can handle that.
  ...
  oppose to specific executive) task delegation.}]\\
...
\begin{description}
  ...
  \item \textit{\textbf{B2. Robot:}} Okay. I can handle that. Is it okay if I
  leave the current task though?
  ...
  \item \textit{\textbf{B10. Robot:}} Do you want me to provide some examples?
