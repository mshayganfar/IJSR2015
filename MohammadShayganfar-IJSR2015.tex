...
associated with each mechanism using JESS (JAVA Expert System Shell), in order
to generate the same type of collaborative behaviors as appear in our examples.
In the future, we are going to use these rules and the processes involved in
each mechanism to develop collaborative behaviors in an interactive robot.
